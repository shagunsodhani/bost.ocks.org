var stack = (function() {
  ...
  function scroll() {
    ...
    d3.select(section[0][yFloor])
        ...
        .style("-o-transform", "translate(0," + (-yError * size) + "px)")
        .style("-moz-transform", "translate(0," + (-yError * size) + "px)")
        .style("transform", "translate(0," + (-yError * size) + "px)")
        .classed("active", yError != yMax);

    d3.select(section[0][yFloor + 1])
        .style("-webkit-transform", "translate3d(0,0,0)")
        .style("-o-transform", "translate(0,0)")
        .style("-moz-transform", "translate(0,0)")
